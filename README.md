...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/openff-nagl-models-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openff-nagl-models-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add openff-nagl-models
# for installing globally
pixi global install openff-nagl-models
```
...
It is possible to list all of the versions of `openff-nagl-models` available on your platform:
...
```
pixi search openff-nagl-models --channel conda-forge
```
